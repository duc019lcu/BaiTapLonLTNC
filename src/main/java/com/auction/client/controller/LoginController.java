 ...
 *
 * <p>
 * Xác thực được thực hiện hoàn toàn ở phía Server (BCrypt verify).
 * Client chỉ gửi username + password thô qua TCP; server trả về kết quả.
 * </p>
 */
public class LoginController {
    ...
    @FXML
    private javafx.scene.shape.SVGPath eyeIcon;
